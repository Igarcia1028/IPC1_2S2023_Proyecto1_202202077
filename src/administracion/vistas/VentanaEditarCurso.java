 ...
 * @author dg551
 */
public class VentanaEditarCurso extends javax.swing.JFrame {
    ...
    public VentanaEditarCurso() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                ventanaAdministrador.setPanel(1);
        ...
        if (seleccion != null) {
            ...
            if (partes.length == 2) {
                ...
                if(gestorCampos.camposVacios(campos)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Los créditos deben ser numéricos mayores a cero");
                } else {
                    gestorCurso.actualizarCurso(codigo, nombre, creditos, objProfesor);
                    guardarBinario();
                    this.dispose();
                    ModuloAdministrador ventanaAdmin = new ModuloAdministrador();
                    ventanaAdmin.dispose();
                    ventanaAdmin.setPanel(1);
    ...
    public void setCreditosTextField(int creditos) {
        txtCreditos.setText(Integer.toString(creditos));
    }
    
    public void setProfesorCmb(String codigo) {
        for (int i = 0; i < cmbProfesores.getItemCount(); i++) {
            String item = cmbProfesores.getItemAt(i).toString();
            if (item.contains(codigo)) {
                cmbProfesores.setSelectedItem(item);
                break;
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEditarCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEditarCurso().setVisible(true);
            }
        });
    }
